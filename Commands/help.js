...
module.exports = {
    ...
    run: async (client, message, args) => {
      ...
      const embed = new MessageEmbed()
            ...
            embed.addFields(
		{ name: '\u200B', value: '\u200B' },
		{ name: "Issues", value: "I am aware of issues with random amounts of downtime, and I'm trying to get the bot running 24/7 again, but may take a bit as I'm not sure what the cause is.", inline: true },
              { name: "s!support", value: "s!support - Gives the link of the support server", inline: true },
    { name: "s!invite", value: "s!invite - Gives the invite link of the bot.", inline: true },
    ...
    { name: "s!8ball", value:  "s!help <question> - Gives you a brief answer that you shouldn't use on a test.", inline: true },
